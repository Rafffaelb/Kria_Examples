...
```
"""
    filename = "kria_fft_architecture.md"
    with open(filename, "w") as f:
        f.write("# Kria FFT Architecture Diagram\n")
        f.write("View this file in VS Code or GitHub to see the rendered block diagram.\n\n")
        f.write(mermaid_code)
    
    print(f"Successfully generated '{filename}'.")
    print("Open this file in your editor to view the diagram without installing Graphviz.")
